 ...
 */
BACNET_CHARACTER_STRING *Multistate_Value_Description(uint32_t object_instance)
{
...
bool Multistate_Value_Write_Property(BACNET_WRITE_PROPERTY_DATA *wp_data)
{
    ...
    fprintf(stderr, "Multistate Value: Write Property %d\n",
        wp_data->object_property); // should be 81
